...
*/
const YOUR_USERNAME = "jpurm";

const MovieSchema = mongoose.Schema({
  title: { type: String, required: "Title is required" },
  year: { type: Number, required: "Year is required" },
  rating: { type: Number, required: "Rating is required" },
  synopsis: { type: String, required: "Synopsis is required" },
  genres: { type: Array, required: "Genres is required" },
